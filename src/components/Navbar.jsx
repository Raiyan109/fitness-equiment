...
const Navbar = () => {
    ...
    return (
        <div>
            <header className="p-4 bg-gray mx-5 lg:mx-20 my-4 lg:my-4 rounded-full">
                <div className="flex justify-between h-8 lg:h-8 py-2 lg:py-3 px-2 lg:px-10">
            ...
            {isMobileMenuOpen && (
                <motion.div
                    ...
                    className="lg:hidden bg-gray m-7 rounded-t-2xl rounded-b-[50px] py-5 absolute  w-[450px] md:w-[870px] top-16 inset-0 bg-opacity-60 backdrop-blur-sm z-10">
